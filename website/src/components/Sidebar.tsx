          ...
          <div id="primary-nav-group" className="space-y-1">
            {visiblePrimaryNav.map((item) => {
              ...
              return (
                ...
                >
                  {isGens ? (
                    <span className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-pink-500 to-red-500 transition-transform duration-200 group-hover:scale-110">
                  ...
                  <span className={`flex-1 text-left ${isGens ? "bg-gradient-to-r from-pink-400 to-red-400 bg-clip-text font-bold text-transparent" : ""}`}>{navLabel}</span>
