...
const zh: Record<string, string> = {
  ...en, home: "首页", movies: "电影", tvShows: "电视剧", signIn: "登录", signUp: "注册",
  settings: "设置", language: "语言", theme: "主题", welcomeBack: "欢迎回来", playNow: "播放",
...
Object.assign(en, {
  ...
  chooseServer: "Choose a Server (3 Available)",
  castCrew: "Cast & Crew",
...
Object.assign(zh, { aboutCinemax: "关于 Cinemax", categories: "分类", allCategories: "全部分类", browseCategories: "浏览分类", browse: "浏览", seeAll: "查看全部", exploreMovies: "探索电影", exploreTvShows: "探索剧集", similarTitles: "你可能喜欢的相似片名", recommendedForYou: "为你推荐", chooseServer: "选择服务器（3 个可用）", castCrew: "演员和团队", liveChatComments: "实时聊天和评论", openDiscussionPanel: "打开演员表下方的社区讨论面板。", hide: "隐藏", open: "打开" });
